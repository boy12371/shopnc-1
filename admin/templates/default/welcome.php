...
<div class="page">
  ...
  <div class="info-panel">
    ...
    <dl class="system">
      ...
      <dd>
        <ul>
          <li class="w50pre none"><a href="http://www.corecreate.cn" target="_blank">官方网站<sub></sub></a></li>
          <li class="w50pre none"><a href="http://www.corecreate.cn" target="_blank">官方论坛<sub></sub></a></li>
        </ul>
      </dd>
    </dl>
    <div class="clear"></div>
